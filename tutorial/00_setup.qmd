...
You need **R 4.4 or newer** ([download from CRAN](https://cran.r-project.org/)) — install
...
You need eight CRAN and twenty Bioconductor packages. The whole installation is short
...
BiocManager::install(c(
  "data.table", "ggplot2", "knitr", "DT", "ggrepel", "ggtext", "fst", "jsonlite",
