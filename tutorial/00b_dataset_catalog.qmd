---
title: "Choosing a dataset: a catalog of 70 EPIC methylation studies on GEO"
resources:
...
Before you can practice an EWAS you need data. This page documents what and
how we picked a curated catalog of **70 Illumina MethylationEPIC studies on 
GEO**, including the dataset used in the tutorial, that carry enough phenotype
...
dataset for a rotation project.
...
start from the true beginning), **both age and sex present**, at least one
...
are a bonus — they give you an answer key to check your own pipeline against.
:::
...
#| echo: false
#| fig-cap: "The 70-study catalog at a glance. (a) Teaching-suitability tiers. (b) How many studies carry each metadata field — note that deposited cell-type composition is rare. (c) Study sizes span 152 to ~3,100 samples. (d) Almost all are EPIC v1 (850K)."
...
against. The cohort also has a long methylation literature behind it — early work
on immune-system methylation in PTSD in this sample [@smith2011grady] through to
the EPIC-array analyses we compare against in notebook
[06](06_ewas.qmd) [@katrinli2020ptsd] — so a student's result can be read against
published findings rather than in a vacuum.
...
which QC/normalization steps you can and cannot still do.
:::
