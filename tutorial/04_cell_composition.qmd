...
Whole blood is not one thing. It is a mixture of neutrophils, monocytes, NK cells,
...
methylation differences that are to the biology you're studying.
...
::: {.callout-important}
## Modeling blood cell proportions
You must **either** adjust for estimated cell proportions as covariates in the EWAS
model, **or** use a reference-free method that captures them as latent components
(covered in [batch effects](05_batch_effects.qmd)). 
:::
