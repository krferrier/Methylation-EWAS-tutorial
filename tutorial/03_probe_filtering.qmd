...
`data/EPIC.hg38.mask.v81.8code.tsv.gz` ships with the tutorial *data* rather than in
the repository, so a fresh clone does not have it. Fetch it before rendering:
